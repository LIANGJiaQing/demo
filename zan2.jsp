...
<%
  ...
  ResultSet rs=stmt.executeQuery("select zanid from dbo.yizanid where name='战狼2'"); 
%> 
...
<%
  ...
  if(a == 0){
	  String sql="insert into dbo.yizanid" +" Values('战狼2','"+id+"')";
	  stmt.executeUpdate(sql);
	  stmt.executeUpdate("update dbo.dianzan set num=num+1 where name='战狼2'");
  }
...
response.sendRedirect("zan1.jsp");
%>
</table></center>
</body></html>